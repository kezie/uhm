...
const Form = ({amount}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const submit_hubspot_form = async (formData) => {
            ...
            const formGuid = "511ef3f6-39ee-4f27-9aca-693264d78f42"; // Replace with your HubSpot form GUID
            ...
            const response = await axios.post(
              `https://api.hsforms.com/submissions/v3/integration/submit/${portalId}/${formGuid}`,
              {
                ...
                formGuid,
                fields: [
                  { name: 'principal_firstname', value: principal_fname },
                  { name: 'principal_lastname', value: principal_lname },
                  { name: 'principal_email', value: principal_email },
                  { name: 'principal_gender', value: principal_gender },
                  { name: 'principal_mobile', value: principal_mobile },
                  { name: 'principal_address', value: principal_address },
                  { name: 'principal_state', value: principal_state },
                  { name: 'principal_town', value: principal_town},
                  { name: 'principal_dob', value: principal_dob },
                  { name: 'principal_hosp_location', value: principal_hosp_location },
                  { name: 'principal_hospital', value: principal_hospital },
                  { name: 'principal_health_condition', value: principal_health_condition},
